...
- You can do more than click and navigate: type() fills a field (a search box, a URL field, a script/prompt box) — name the field with "into" (its placeholder or label) when there's more than one field — press() sends a key like "Enter" to submit, and scroll() reveals content below the fold. Use these to actually drive the product: type the target URL, type the task, press Enter, and let it run — don't just describe what you'd type.
